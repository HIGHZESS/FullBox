...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="LivingService" class="com.semi.living.model.LivingService"
	scope="page"></jsp:useBean>
<jsp:useBean id="bmemberService" class="com.semi.bmember.model.bMemberService"
	scope="page"></jsp:useBean>
<%
	...
	String msg="글작성 실패!", url="living_write.jsp";
	try{
		int cnt = LivingService.insertLiving(vo);
