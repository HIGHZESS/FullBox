...
try {
	list = reviewService.selectPhotoReview();
...
<div class="ReviewNav">
		<div class="nav">
			<a class="nav-link" href="AllReview.jsp">모든후기</a> 
			<a class="nav-link"href="ReviewOnlyPhoto.jsp">사진후기</a> 
			<a class="nav-link" href="ReviewWrite.jsp">후기작성하기</a>
